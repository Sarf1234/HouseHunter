...
const Heropage = () => {
    return (
        <div>
            ...
            <div className="md:h-screen h-[90vh]  w-screen flex-wrap  flex">
                <div className="md:h-full w-full  md:w-1/2 flex justify-center md:items-center">
                    <div className=" md:ml-20 mt-[120px] w-full px-4 md:px-0 md:w-[480px] h-7/8 md:h-[400px] md:mt-20">
                        <div className="md:h-1/3">
                           <h1 className=" overflow-y-hidden text-[32px] md:text-3xl md:w-5/6 leading-16 text-[#1B1C57] font-bold uppercase" style={{fontFamily:"Lexend"}}>
                              find the place to
                              live <span className="stroke-black text-[36px] md:text-[38px] font-sans" style={{"WebkitTextStroke":" 1px black","WebkitTextFillColor": "transparent"}}>your dreams</span> easily here   
                           </h1>
                        </div>
                        <div className="md:h-1/3 py-4 overflow-y-hidden">
                           ...
                           <div className="border my-4 rounded-[14px]">
                             <div className="flex justify-between items-center">
                                <div className="align-center px-2 md:px-0 md:ml-4">
                                ...
                                <input type="text"  className="border w-full md:w-[300px] py-2 outline-none border-none bg-transparent" placeholder="Search for the location you want!"/>
                                <button className=" px-5 bg-green-600 text-white m-[2px] py-2 rounded-[14px]">Search</button>
                             </div>
                           </div>
                        </div>
                        <div className="md:h-1/3 my-4 md:my-0 ">
                           <p className="text-base md:my-3 opacity-75 text-[#626687]">Our Partnership </p>
                           <div className="md:my-3 flex justify-between flex-wrap md:flex-nowrap items-center w-full md:w-5/6">
                              <div>
                                <img src={image1} />
                              </div>
                              <div>
                ...
                <div className="h-full hidden md:block md:w-1/2 iimageurl bg-[url(./assets/image6.png)] bg-cover bg-center bg-no-repeat"></div>
            </div>
        </div>
    )
}
